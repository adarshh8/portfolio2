...
const About = () => {
  ...
  const handleDownload = () => {
    ...
    link.download = "Adarsh_Dwivedi_Resume.pdf";
    link.click();
  };
      ...
      >
        ...
        >
          <ProfileCard
            ...
            location="India"
            linkedinUrl="https://linkedin.com/in/adarsh8"
          />
        </motion.div>
        <motion.div
          variants={container}
        ...
        >
          ...
          <motion.div variants={fadeUp} className="relative pl-6">
            ...
            <p className="text-gray-300 text-sm sm:text-base leading-relaxed">
              ...
              full-stack applications with AI/ML integrations.
            </p>
          </motion.div>
          <motion.div
            variants={fadeUp}
          ...
          >
            <p className="text-[#80978F] text-sm sm:text-base leading-relaxed italic">
              ...
              I am highly disciplined, leadership-oriented, and innovative.&quot;
            </p>
          </motion.div>
          <motion.div
            variants={container}
          ...
          {/* Education & Achievements Section added */}
          <motion.div
            variants={container}
            className="space-y-4 pt-4 border-t border-gray-800/50 w-full"
          >
            <motion.h3 variants={fadeUp} className="text-lg text-[#80978F] text-center lg:text-left">
              Education
            </motion.h3>
            <motion.div variants={fadeUp} className="text-gray-300 text-sm">
              <div className="flex justify-between items-start">
                <div>
                  <h4 className="font-semibold text-[#27CBCB]">B.Tech in CSE</h4>
            ...
            <motion.h3 variants={fadeUp} className="text-lg text-[#80978F] pt-2 text-center lg:text-left">
              Training & Certifications
            </motion.h3>
            <motion.div variants={fadeUp} className="text-gray-300 text-sm space-y-2">
              <p className="text-xs"><span className="text-[#27CBCB]">CSE Pathshala (AI/ML)</span> - Core Python and AI workflows (Mar 2024)</p>
              <p className="text-xs"><span className="text-[#27CBCB]">C, Java</span> - HackerRank (Nov 2025)</p>
              <p className="text-xs"><span className="text-[#27CBCB]">ChatGPT-4 Prompt Engineering</span> - Infosys (Aug 2025)</p>
              <p className="text-xs"><span className="text-[#27CBCB]">Cloud Computing</span> - NPTEL (Apr 2025)</p>
            </motion.div>

            <motion.h3 variants={fadeUp} className="text-lg text-[#80978F] pt-2 text-center lg:text-left">
              Achievements
            </motion.h3>
            <motion.div variants={fadeUp} className="text-gray-300 text-sm space-y-2 pb-4">
