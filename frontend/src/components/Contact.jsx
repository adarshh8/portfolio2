import { ExternalLink, Send, Mail } from "lucide-react";
    ...
    try {
      await emailjs.send(
        ...
        EMAILJS_TEMPLATE_ID,
        {
          ...
          to_email: "adarshdwivedi9598@gmail.com",
        },
        EMAILJS_PUBLIC_KEY
      );
      ...
      <div className="grid md:grid-cols-2 gap-16 items-center">
        <motion.div variants={fade} initial="hidden" whileInView="show">
          ...
          <div className="mt-10 space-y-4">
            ...
            <motion.a
              whileHover={{ x: 6 }}
              href="https://linkedin.com/in/adarsh8"
              target="_blank"
              className="flex items-center gap-4 p-4 rounded-xl border border-gray-800 bg-gray-900/40 backdrop-blur-sm"
            >
            ...
            <motion.a
              whileHover={{ x: 6 }}
              href="mailto:adarshdwivedi9598@gmail.com"
              className="flex items-center gap-4 p-4 rounded-xl border border-gray-800 bg-gray-900/40 backdrop-blur-sm"
            >
              <Mail className="text-2xl text-red-400" />
              <div>
                <p className="font-medium text-gray-200">Email</p>
                <p className="text-sm text-gray-400">adarshdwivedi9598@gmail.com</p>
              </div>
              <ExternalLink className="ml-auto opacity-60" />
            </motion.a>
          </div>
